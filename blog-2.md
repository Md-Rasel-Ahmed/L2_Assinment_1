...
**Pick** and **Omit** are the utilities of TapeScript

For example, I have an object interface for user information, now I want to change the name of the user, I will change the age and I will change it.
